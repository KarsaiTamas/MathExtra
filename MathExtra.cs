...
public struct MathExtra
{
    ...
    public static bool IsHitWall(Vector3 nextPos,Tilemap wall)
    {
        var grid = wall.layoutGrid;
        var cellToGo = grid.WorldToCell(nextPos);
        return (wall.GetTile(cellToGo) != null);
    ...
    /// </param>
    /// <returns></returns>
    public static Vector3 GetCoordinatesBetween2ObjectsForGuards(
        int guardNumber,
        float pos,
    ...
    {
        //Get a Lerp value based on the guard's number and the alive guards
